...
public class BookController {
	...
	public String productList(Integer pageNum,Model model,String type,String key,String max,String min,HttpServletRequest request,HttpSession session){
		Set<String> bts=bookService.bookType();
